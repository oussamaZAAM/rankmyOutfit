  ...
  return (
    <>
      ...
      <div className="grid grid-cols-8 w-full">
        <div className="md:col-start-2 col-span-8 md:col-span-6 flex flex-col justify-center items-center shadow-md rounded bg-[url('https://i.ibb.co/S6ZFbKj/sun-Tornado1.png')]">

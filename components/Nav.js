...
const Nav = () => {
  return (
    <div className='grid grid-cols-8 w-full h-16'>
        <div class="grid grid-cols-8 justify-center items-center h-full col-start-0 col-span-8 lg:col-start-2 lg:col-span-6">
            <div className='flex justify-center items-center | col-span-5 sm:col-span-4 md:col-span-2'>
                <MdOutlineImageSearch color='#DB76DC' size={30} />
                <h1 className='text-xl font-black font-display' style={{color: '#DB76DC'}}>rankmyOutfit</h1>
            </div>
